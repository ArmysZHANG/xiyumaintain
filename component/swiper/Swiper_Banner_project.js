...
import Chart_bar_project from '../chart/Chart_bar_project'
import Table_project from '../table/Table_project'
export default class Swiper_Banner_project extends Component {
    static defaultProps={
        lefttext1:'',
        righttext1:'',
        lefttext2:'',
